...
int HumanBot::StartHuman(int32_t GamePort, int32_t StartPort, std::string ServerAddress, bool COmputerOpponent, std::string OpponentId, std::string PlayerName)
{
    ...
    RunBot(this, Race, *Options, PlayerName);
